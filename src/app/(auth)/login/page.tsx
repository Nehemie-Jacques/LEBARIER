...
export default function LoginPage() {
  ...
  const getInputClassName = (hasError: boolean) => {
    const baseClass = 'w-full py-3 bg-background border rounded-lg text-foreground placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all';
