...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'gold': '0 4px 6px -1px rgba(212, 175, 55, 0.3), 0 2px 4px -1px rgba(212, 175, 55, 0.2)',
        'gold-lg': '0 10px 15px -3px rgba(212, 175, 55, 0.3), 0 4px 6px -2px rgba(212, 175, 55, 0.2)',
        'gold-xl': '0 20px 25px -5px rgba(212, 175, 55, 0.3), 0 10px 10px -5px rgba(212, 175, 55, 0.2)',
